"""
vid_synch  –  Timestamp-based Multi-Camera Video Synchronization & Plotting
=============================================================================
...
Quick-start
-----------
    from vid_synch import vid_synch

    trial = "./recordings/2026-02-04_12-00-00"
    results, figs = vid_synch(trial, target_fps=30.0)
...
def vid_synch(
    ...
    -------
    >>> from vid_synch import vid_synch
    >>> results, figs = vid_synch("./recordings/2026-02-04_12-00-00",
    ...                           target_fps=30.0)
    """
